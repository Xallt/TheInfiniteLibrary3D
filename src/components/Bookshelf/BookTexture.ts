...
export class BookTexture {
  ...
  public getSpineUVs(): number[] {
    return [
      this.params.rightCoverPosition,
      1, // top right
      this.params.leftCoverPosition,
      1, // top left
      this.params.rightCoverPosition,
      0, // bottom right
      this.params.leftCoverPosition,
  ...
  public getSpineTopSideUVs(): number[] {
    return [
      this.params.leftCoverPosition,
      -BookTexture.UV_OFFSET, // bottom left
      this.params.rightCoverPosition,
      -BookTexture.UV_OFFSET, // bottom right
      this.params.leftCoverPosition,
      0, // top left
      this.params.rightCoverPosition,
      0, // top right
  ...
  public getSpineBottomSideUVs(): number[] {
    return [
      ...
      1, // bottom right
      this.params.leftCoverPosition,
      1 + BookTexture.UV_OFFSET, // top left
      this.params.rightCoverPosition,
      1 + BookTexture.UV_OFFSET, // top right
    ];
  }
  ...
  public getLeftLeftUVs(): number[] {
    return [-BookTexture.UV_OFFSET, 0, 0, 0, -BookTexture.UV_OFFSET, 1, 0, 1];
  }

  public getRightRightUVs(): number[] {
    return [1, 0, 1 + BookTexture.UV_OFFSET, 0, 1, 1, 1 + BookTexture.UV_OFFSET, 1];
  }
}
